...
整个暮色森林采用**首领进度制**：你需要按照特定的顺序击败各个首领，才能逐步深入更危险的区域——直接闯进高级区域会被进度屏障挡住。

> [!WARNING]
> 暮色森林的敌对生物强度明显高于主世界，进入前请准备好铁质以上的装备、食物和床。在暮色森林中睡觉会改变重生点，死亡后可以直接回到探险现场附近。

## 词条导航

| 页面 | 内容 |
|:-----|:-----|
| [进入暮色森林](./portal.md) | 传送门的搭建方法、激活条件与返回方式 |
| [首领与进度](./bosses.md) | 首领征服顺序、进度屏障的解锁条件 |
| [探索与地图](./exploring.md) | 三种魔法地图、迷宫地图与实用小物件 |
| [物产与美食](./food.md) | 暮色特产食材，以及整合包中两个美食附属带来的菜肴 |
